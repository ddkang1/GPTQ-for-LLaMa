...
def get_starcoder(model, checkpoint, wbits, groupsize):
    if wbits == 16:
...
def main():
    ...
    parser.add_argument("model", type=str, help="model to load, such as bigcode/gpt_bigcode-starcoder")
    ...
    t1 = time.time()
    model = get_starcoder(args.model, args.load, args.wbits, args.groupsize)
    t2 = time.time()
